...
class MailistController extends Controller
{
	...
	{	
        ...
        return array(
        	array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','delete','admin','addcustomer','deletecustomer'),
				'users'=>array('@'),
                'expression'=>$User,
			),
	...
	{
		$dataProvider=new CActiveDataProvider('Mailist');
	...
	{
		$model=new Mailist('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Mailist']))
			$model->attributes=$_GET['Mailist'];
	...
	{
		$model=Mailist::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mailist-form')
		{
