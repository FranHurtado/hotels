...
<?php if ( $showHeader ) { ?>
    ...
    <div id="dash-header">
        <span id="dash-controls">
            ...
            <a href="#" id="all_close" title="<?php echo Yii::t('Dashboard', 'Hide')?>">
                <?php echo CHtml::image("$url/up.gif");?>
            </a>
        </span>
        <a href="#" id="all_expand" title="<?php echo Yii::t('Dashboard', 'Expand all')?>">
            <?php echo CHtml::image("$url/down.png");?>
        </a>
        <a href="#" id="all_collapse" title="<?php echo Yii::t('Dashboard', 'Collapse all')?>">
            <?php echo CHtml::image("$url/up.png");?>
        </a>
        <a href="#" id="all_invert" title="<?php echo Yii::t('Dashboard', 'Invert state')?>">
            <?php echo CHtml::image("$url/invert.gif");?>
        </a>
        &nbsp;
        <?php if( (!$autoSave) and ($editable) ) { ?>
         <a href="#" id="all_save" title="<?php echo Yii::t('Dashboard', 'Save state')?>">
            <?php echo CHtml::image("$url/save.png");?>
         </a>
        <?php } ?>
        <?php if($editable) { ?>
         <a href="<?php echo "$resetUrl";?>" title="<?php echo Yii::t('Dashboard', 'Restore state to default')?>">
        ...
        <span id="msgSave" style="display:none; margin-left: 30px;">
            <?php echo Yii::t('Dashboard', 'Saved.')?>
        </span>
